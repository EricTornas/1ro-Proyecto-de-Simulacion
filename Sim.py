...
for j in range(cantS):
    result = simulate_insurance_risk_model(
        a0, n0, param_lambda, param_ni, param_mi, c, T, F
    )
...
print(
    f"Varianza de las ganancias maximas de las de las simulaciones: {varianza_ganancias_maximas}"
)
print(
    f"Media del costo total de las reclamaciones: {media_Capital_perdido_por_reclamación }"
)
print(
    f"Varianza del costo total de las reclamaciones: {varianza_Capital_perdido_por_reclamación}"
)
